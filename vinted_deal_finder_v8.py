...
DETAIL_SLEEP_SECONDS = 1.0  # pauze tarp /api/v2/users/{id} uzklausu (pardavejo info)
...
def get_photo_url(item):
    """Isrenka skelbimo nuotraukos URL is JSON API objekto (keli galimi laukai)."""
