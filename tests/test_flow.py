...
class FlowTest(unittest.TestCase):
    ...
    def test_deal_rejects_and_silent(self):
        with TempDir():
            ...
            for reason in ["iCloud / užblokuotas / dalims", "ne telefonas / kitas modelis", "kalba", "salis",
                           "per pigu telefonui (priedas?)"]:
    ...
    def test_sold_check_and_sold_prices(self):
        ...
        with TempDir():
            ...
            d = today() - 3
            state = {"market": {"items": {str(i): {"m": "13", "s": "128 GB", "p": 190 + i, "f": d, "l": d,
